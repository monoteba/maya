...
class replace_file_node_paths:
	...
	def do_replace():
		...
		method = pm.confirmDialog(title='Search/replace file textures', 
	...
	def manual_mode():
		...
		# prompt for paths
		search_p = pm.promptDialog(text=search, title='Search/Replace', message='Search for file node paths...', button=['OK', 'Cancel'], defaultButton='OK', cancelButton='Cancel', dismissString='Cancel')
		search = pm.promptDialog(q=True, text=True)
		replace_p = pm.promptDialog(text=replace, title='Search/Replace', message='... replace with:', button=['OK', 'Cancel'], defaultButton='OK', cancelButton='Cancel', dismissString='Cancel')
